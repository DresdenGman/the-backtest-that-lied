...
\subsection{Data}
RQAlpha A-share daily market-data bundle, 5511.0 historically listed stocks. Point-in-time universe without survivorship filters. Daily OHLCV aggregated to monthly. True PIT fundamental data (market cap, book value, earnings, industry) was unavailable.
...
All numerical claims generated from \texttt{data/evidence.json} (39 metrics, 3 collapses). \texttt{scripts/validate\_evidence.py} + \texttt{tests/test\_evidence.py} enforce integrity.
