...
\begin{enumerate}[label=(\arabic*)]
    \item \textbf{Cross-sectional predictability existed.} The retained IC of 0.108{} across 96 pooled out-of-sample months was statistically robust under Newey--West adjustment ($t = 10.5$) and block-bootstrap inference.
    \item \textbf{The signal was concentrated in illiquid stocks.} ADV20 quintile decomposition revealed that +48.1{} of holdings resided in the lowest-liquidity quintile (median daily volume \textyen 19M). Within this quintile, genuine stock selection was demonstrated (+2.7{} monthly excess).
    ...
    \item \textbf{Longer horizons did not rescue scalability.} Three-month and six-month prediction targets, tested through the identical execution engine, produced negative liquid-universe returns (H3: -21.7, H6: -15.2{} net annual).
\end{enumerate}
